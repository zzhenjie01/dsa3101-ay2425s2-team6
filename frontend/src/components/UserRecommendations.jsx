...
function transformData(data) {
    ...
    const environmentalScore = data.map(c => c.environmentalScore).sort((a, b) => a - b);
    const socialScore = data.map(c => c.socialScore).sort((a, b) => a - b);
    const governanceScore = data.map(c => c.governanceScore).sort((a, b) => a - b);

    // Map the companies array to replace scores with percentiles
    const companiesWithPercentiles = data.map(company => ({
        company_name: company.company,
        e_percentile: getPercentileRank(environmentalScore, company.environmentalScore),
