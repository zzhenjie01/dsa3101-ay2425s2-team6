...
const sidePanelButtonsLst = [
    ...
    {idx: 3, buttonName: 'Company Summary', onClickText: 'Company Summary View'},
    {idx: 4, buttonName: 'Company Financial Indicators', onClickText: 'Company Financial Indicators View'},
  ]
