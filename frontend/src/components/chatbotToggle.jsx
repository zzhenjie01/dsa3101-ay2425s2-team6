  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-2"> 
        {messages.map((msg, index) => ( // Chat history field
          <div
            key={index}
            className={`p-2 rounded-lg text-white max-w-[75%] ${
              msg.sender === "user" ? "bg-blue-500 self-end" : "bg-gray-400 self-start"
            }`}
          >
            {msg.text}
          </div>
      ...
      <div className="flex p-2 border-t"> 
        ...
        />
        <button className="bg-blue-600 text-white px-4 rounded-r-lg" onClick={sendMessage}>
