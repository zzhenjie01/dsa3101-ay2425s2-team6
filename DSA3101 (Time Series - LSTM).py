...
#- company_csv_file - the name of the CSV file that contains all of the historical stock prices of the different companies (CSV files of the
#historical stock prices of the different companies were derived from the Nasdaq website)
#- working_directory - the working directory of where the company_csv_file is stored in (your local directory that contains the CSV file of
#of the specific company you want to look at)
#- company_name - the name of the company
#- output_csv_file_name - the name of the CSV file that will be part of the output of the function
...
def get_predicted_stock_prices(company_csv_file, working_directory, company_name, output_csv_file_name):
    #Gets the working directory where company_csv_file is stored in in your local directory
    os.chdir(working_directory)


    
    #Loading company_csv_file as a Pandas dataframe and performing data transformation (e.g. making the Date column into a DateTime column)
    ...
    #stock_data_close: will only contain the Close/Last column
    ...
    #Creating the training dataset and the testing dataset for the LSTM model
    ...
    #Creating the LSTM model + training the model on the training dataset
    model = Sequential()
    ...
    df_1.to_csv(output_csv_file_name, index = False) #will save the dataframe with the forecasted dates and prices of the company as a CSV file
    return df_1
